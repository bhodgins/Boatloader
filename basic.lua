...
local function print( ... )
	if cclite ~= nil and cclite.log ~= nil then cclite.log( ... ) end -- Debugging
	local nLinesPrinted = 0
...
local function loadfile( _sFile )
...
local function getmetatable( _t )
...
function os.pullEvent( _sFilter )
	local eventData = { coroutine.yield( _sFilter ) }
